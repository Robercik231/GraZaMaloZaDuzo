...
namespace GraGUI
{
    public partial class Form1 : Form
    {
        ...
        private void buttonNowaGra_Click(object sender, EventArgs e)
        {
            ...
            zgadywanaLiczba.Text = "";

            czas_gry.Text = "";
            liczba_ruchow.Text = "";
            wylosowana_liczba.Text = "";
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            czas_gry.Text = (DateTime.Now - startTime).ToString();
            liczba_ruchow.Text = g.LicznikRuchow.ToString();
            wylosowana_liczba.Text = g.Wylosowana.ToString();
